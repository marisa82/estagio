window.onload = function() {
    ...
    //vars
    var tracker = 0,
      slidewindow = document.querySelector("#slidewindow"),
      slides = document.querySelectorAll("#slidewindow div"),
      next = document.querySelector("#controls #next"),
      prev = document.querySelector("#controls #prev"),
      dots = document.querySelector("#controls #dots"),
  ...
  var acc = document.getElementsByClassName("product_list_item_title");
  var i;
